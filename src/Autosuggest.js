...
export default class Autosuggest extends Component {
  static propTypes = {
    ...
    sectionNameRenderer: PropTypes.func     // Optional function to be used to override the default renderer of section name (used only for multiple sections)
  }
      ...
      return (
        <div id={'react-autosuggest-' + this.props.id}
          ...
          {this.state.suggestions.map((section, sectionIndex) => {
            const sectionNameRender = this.props.sectionNameRenderer ?
              this.props.sectionNameRenderer(section) : section.sectionName;
